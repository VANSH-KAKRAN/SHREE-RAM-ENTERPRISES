...
<div className="left">
  ...
  <div className="double-info">
    <p className='name'> <li className='vr'></li>&nbsp;&nbsp;   {props.name}</p>
    <p className='size'>{props.data1}</p>
    <p className='feature-h'>Features :</p>
    <p className='features'> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-check-lg" viewBox="0 0 16 16">
